          ...
          <div className="modal-content details-modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body">
              <div className="details-section">
                <h4>AI Generated Questions ({examQuestions.generated.length})</h4>
                <div className="questions-list">
                  ...
                  {examQuestions.generated.length === 0 && <p>No questions generated by AI.</p>}
                </div>
              </div>
              <div className="details-section">
                <h4>Manual Answer Key ({examQuestions.manual.length})</h4>
                <div className="questions-list">
                  ...
                  {examQuestions.manual.length === 0 && <p>No manual answers defined.</p>}
                </div>
              </div>
              <div className="details-section">
